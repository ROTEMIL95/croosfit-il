...
const SimilarExericses = ({ equipmentExercisesData, targetExercisesData }) => {
    return (
        <Box sx={{ mt: { lg: '100px', }, p: { xs: '20px' } }}>
            <Typography variant="h4" mb={7} sx={{ fontSize: { xs: '22px' }, color: "#FFD6AE", p: { xs: '5px' }, marginTop: { xs: '20px' } }}>
            ...
            <Typography variant="h4" mt={10} sx={{ fontSize: { xs: '22px' }, marginTop: { lg: '200px', xs: '150px' }, color: "#FFD6AE" }}>
